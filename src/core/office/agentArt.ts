 ...
 */
const TEACHER_FORM =
  // 頭身は「2頭身」と書くだけでは伝わらず、4〜5頭身の立ち姿が返ってきた。
  // 割合を絵の言葉（頭の高さ＝首から下の高さ）で言い直している。
  'やわらかい3DCGの人形。頭がとても大きく体が小さい、頭でっかちな体型。' +
  '頭の高さと、首から足先までの高さが、ちょうど同じくらい。赤ちゃんのような釣り合い。' +
  '頭のてっぺんに猫の耳、うしろに猫のしっぽ。' +
  '髪の毛・めがね・鼻は描かない。つるりとした頭。' +
  '腕と脚は短く、手には指がある。' +
  '目は小さな白い楕円の中に黒い丸、口はおだやかな笑み。' +
  'つやのある粘土のような質感で、やわらかい光が当たっている。' +
  '実在の人物には似せない。性別や年齢が読み取れる描き方をしない' +
  '（ひげ・化粧・体型の強調を描かず、中性的にする）。' +
  // 以前「まわりのマスコットより少し大きい」と書いたら、比べる相手のほうを
  // 背景に描き込んできた。大きさは表示側のサイズ指定で扱い、絵には持ち込まない。
  '画面にはこの一体だけを描き、他のキャラクターは描かない。';
